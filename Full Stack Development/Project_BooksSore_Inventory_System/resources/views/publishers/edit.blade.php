                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body card-block">
                            <form action="{{route('publisher.update',$publisher->id)}}" method="POST" enctype="multipart/form-data" class="form-horizontal">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <input type="email" id="text-input" name="email"
                                            placeholder="{{$publisher['email']}}" class="form-control">
                                    </div>
                                </div>
                                <div class="row form-group">
                                    <div class="col col-md-3">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <input type="tel" id="text-input" name="phone"
                                            placeholder="{{$publisher['phone']}}" class="form-control">
                                    </div>
                                </div>
                                <div class="row form-group">
                                    <div class="col col-md-3">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <input type="text" id="text-input" name="address"
                                            placeholder="{{$publisher['address']}}" class="form-control">
                                    </div>
                                </div>
                                <div class="row form-group">
                                    <div class="col col-md-3">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <input type="text" id="text-input" name="website"
                                            placeholder="{{$publisher['website']}}" class="form-control">
                                    </div>
                                </div>
                                <div class="row form-group">
                                    <div class="col col-md-3">
